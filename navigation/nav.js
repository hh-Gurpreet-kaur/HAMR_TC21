...
class CustomNavigator extends React.Component {
	...
	static router = {
		...
		getStateForAction: (action, lastState) => {
			...
			const defaultResult = AuthStack.router.getStateForAction(action, lastState);

			// This stops the navigation drawer from opening while scanning
			if (( action.type == NAVIGATE_ACTION || action.type == TOGGLE_DRAWER_ACTION)
